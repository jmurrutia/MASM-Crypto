...
;     November 3, 2016
;     Visual Studio 2015
;     TITLE Text Encrption Crypto Program
;     This program uses C++ and Masm in mixed mode to take
;     an inputed string of text, encrypts the text and displays it, 
;     then decrypts the text and displays the original text.
*/
